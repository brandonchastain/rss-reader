...
{
    Task<IEnumerable<NewsFeedItem>> GetItemsAsync(NewsFeed feed, bool isFilterUnread, bool isFilterSaved, string filterTag, int? page = null, int? pageSize = null, long? lastId = null, long? lastPublishDateOrder = null, IEnumerable<string> excludeFeedUrls = null);
